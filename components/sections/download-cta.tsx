    ...
    <section id="download" className="py-20">
      ...
      >
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link href="https://apps.apple.com/us/app/buzz-me-up/id6502783779?uo=2" className="hover:scale-105 transition-transform duration-300">
            <Image
          ...
          <Link href="https://apps.apple.com/us/app/buzz-me-up/id6502783779?uo=2">
            <Button
              variant="outline"
